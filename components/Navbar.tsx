...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white w-full py-4 sm:py-6 lg:py-8 px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        
        {/* Left Section: Title and Subtitle */}
        <div className="w-full sm:w-auto">
          <h1 className="text-xl lg:text-2xl font-semibold text-gray-900">SocialSync Dashboard</h1>
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto">
          ...
          <button 
            ...
            className="flex items-center justify-center px-4 py-2.5 
              text-sm font-medium text-white bg-blue-500 rounded-lg 
