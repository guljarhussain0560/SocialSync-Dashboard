...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white w-full py-4 px-6 border-2 border-gray-200">
      <div className="flex items-center justify-between px-50">
        {/* Left Section: Title and Subtitle */}
        <div>
          <h1 className="text-3xl mt-8 text-gray-900">SocialSync Dashboard</h1>
          <p className="text-sm mt-2 text-gray-500">Create, publish, and track posts across all your social media channels from one place.</p>
        </div>
